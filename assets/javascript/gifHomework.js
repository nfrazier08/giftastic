...
//STEP 2: Set up query URL
	var queryURL = "http://api.giphy.com/v1/gifs/search?q=" + 
				animals + "&api_key=e22a26b4f57540b8af89c62d87bb33a6&limit=10";
...
//STEP 3: Create buttons out of the original array of animals 
	...
	function renderButtons(){
		...
		for (var i = 0; i < animals.length; i++) {
			$(".addedAnimalButtons").append("<button>" + animals[i] + "</button>");
		} //End of the for loop
...
//STEP 5: Set up ajax function to request information Giphy
...
//STEP 6: When user clicks animal buttons up top
	//ten gifs AND their rating will be displayed into the gifDump




//STEP 7: When the user adds an animal using the form, 
	//A button for the new animal will be created
	//the new animal is PUSHED into the array of animals
		//That now has access to the GIPHY API

//STEP 8: Create a function where the player can:
